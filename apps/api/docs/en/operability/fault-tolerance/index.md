...
- This index groups `apps/api` conventions for handling failures when calling external dependencies.
  ...
  - Covered convention topics include retry, timeout/deadline, async/workflow/saga retry, circuit breaker, idempotent receiver, retry budget, and related mechanisms.
